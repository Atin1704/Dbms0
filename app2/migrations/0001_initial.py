    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff', models.ForeignKey(blank=True, db_column='staffid', null=True, on_delete=django.db.models.deletion.SET_NULL, to='app2.admin')),
            ],
            options={
                'db_table': 'organizer',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organizer', models.ForeignKey(blank=True, db_column='organizerid', null=True, on_delete=django.db.models.deletion.SET_NULL, to='app2.organizer')),
            ],
            options={
                'db_table': 'event',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(db_column='eventid', null=True, on_delete=django.db.models.deletion.SET_NULL, to='app2.event')),
                ('user', models.ForeignKey(db_column='userid', null=True, on_delete=django.db.models.deletion.SET_NULL, to='app2.user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('event', models.ForeignKey(db_column='eventid', null=True, on_delete=django.db.models.deletion.SET_NULL, to='app2.event')),
                ('transaction', models.ForeignKey(db_column='transactionid', null=True, on_delete=django.db.models.deletion.SET_NULL, to='app2.transaction')),
                ('user', models.ForeignKey(db_column='userid', null=True, on_delete=django.db.models.deletion.SET_NULL, to='app2.user')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='event',
            name='venue',
            field=models.ForeignKey(blank=True, db_column='venueid', null=True, on_delete=django.db.models.deletion.SET_NULL, to='app2.venue'),
        ),
        migrations.CreateModel(
            name='Feedback',
            fields=[
                ...
                ('Created_At', models.DateTimeField(auto_now_add=True, db_column='createdat')),
                ('event', models.ForeignKey(db_column='eventid', on_delete=django.db.models.deletion.CASCADE, to='app2.event')),
                ('user', models.ForeignKey(db_column='userid', on_delete=django.db.models.deletion.CASCADE, to='app2.user')),
            ],
            options={
                'db_table': 'feedback',
